...
conf = coval_sdk.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("coval_sdk")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        """
        auth: AuthSettings = {}
        if 'Coval_Agents_API_ApiKeyAuth' in self.api_key:
        ...
        if 'Coval_Dashboards_API_ApiKeyAuth' in self.api_key:
            auth['Coval_Dashboards_API_ApiKeyAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-API-Key',
                'value': self.get_api_key_with_prefix(
        ...
        if 'Coval_Metrics_API_ApiKeyAuth' in self.api_key:
            auth['Coval_Metrics_API_ApiKeyAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-API-Key',
                'value': self.get_api_key_with_prefix(
        ...
        if 'Coval_Agent_Mutations_API_ApiKeyAuth' in self.api_key:
            auth['Coval_Agent_Mutations_API_ApiKeyAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-API-Key',
                'value': self.get_api_key_with_prefix(
        ...
        if 'Coval_Reports_API_ApiKeyAuth' in self.api_key:
            auth['Coval_Reports_API_ApiKeyAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'x-api-key',
                'value': self.get_api_key_with_prefix(
        ...
        if 'Coval_Reviews_API_ApiKeyAuth' in self.api_key:
            auth['Coval_Reviews_API_ApiKeyAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-API-Key',
                'value': self.get_api_key_with_prefix(
        ...
        if 'Coval_Run_Templates_API_ApiKeyAuth' in self.api_key:
            auth['Coval_Run_Templates_API_ApiKeyAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-API-Key',
                'value': self.get_api_key_with_prefix(
        ...
        if 'Coval_Runs_API_ApiKeyAuth' in self.api_key:
            auth['Coval_Runs_API_ApiKeyAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-API-Key',
                'value': self.get_api_key_with_prefix(
        ...
        if 'Coval_Scheduled_Runs_API_ApiKeyAuth' in self.api_key:
            auth['Coval_Scheduled_Runs_API_ApiKeyAuth'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-API-Key',
                'value': self.get_api_key_with_prefix(
        ...
        if 'Test_Sets_API_apiKey' in self.api_key:
            auth['Test_Sets_API_apiKey'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-API-Key',
                'value': self.get_api_key_with_prefix(
