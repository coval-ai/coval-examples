...
class AgentsApi:
    ...
    def duplicate_agent(
        self,
        agent_id: Annotated[str, Field(strict=True, description="ID of the agent to duplicate")],
        duplicate_agent_request: Optional[DuplicateAgentRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param agent_id: ID of the agent to duplicate (required)
        :type agent_id: str
        :param duplicate_agent_request:
        :type duplicate_agent_request: DuplicateAgentRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._duplicate_agent_serialize(
            agent_id=agent_id,
            duplicate_agent_request=duplicate_agent_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def duplicate_agent_with_http_info(
        self,
        agent_id: Annotated[str, Field(strict=True, description="ID of the agent to duplicate")],
        duplicate_agent_request: Optional[DuplicateAgentRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def duplicate_agent_without_preload_content(
        self,
        agent_id: Annotated[str, Field(strict=True, description="ID of the agent to duplicate")],
        duplicate_agent_request: Optional[DuplicateAgentRequest] = None,
        _request_timeout: Union[
    ...
    def _duplicate_agent_serialize(
        self,
        agent_id,
        duplicate_agent_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if duplicate_agent_request is not None:
            _body_params = duplicate_agent_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/agents/{agent_id}/duplicate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
