...
class SimulationsApi:
    ...
    def update_simulation(
        self,
        simulation_id: Annotated[str, Field(min_length=22, strict=True, max_length=27, description="The simulation ID")],
        coval_simulations_api_update_simulation_request: Optional[CovalSimulationsAPIUpdateSimulationRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param simulation_id: The simulation ID (required)
        :type simulation_id: str
        :param coval_simulations_api_update_simulation_request:
        :type coval_simulations_api_update_simulation_request: CovalSimulationsAPIUpdateSimulationRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_simulation_serialize(
            simulation_id=simulation_id,
            coval_simulations_api_update_simulation_request=coval_simulations_api_update_simulation_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CovalSimulationsAPIUpdateSimulationResponse",
            '400': "CovalSimulationsAPIErrorResponse",
            '401': "CovalSimulationsAPIErrorResponse",
            '403': "CovalSimulationsAPIErrorResponse",
            '404': "CovalSimulationsAPIErrorResponse",
            '500': "CovalSimulationsAPIErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    def update_simulation_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CovalSimulationsAPIUpdateSimulationResponse]:
        """Update simulation
    ...
    def _update_simulation_serialize(
        self,
        simulation_id,
        coval_simulations_api_update_simulation_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if coval_simulations_api_update_simulation_request is not None:
            _body_params = coval_simulations_api_update_simulation_request
