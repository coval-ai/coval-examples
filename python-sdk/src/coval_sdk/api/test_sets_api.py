...
class TestSetsApi:
    ...
    def list_test_set_records(
        self,
        test_set_id: Annotated[StrictStr, Field(description="Test set id.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param test_set_id: Test set id. (required)
        :type test_set_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_test_set_records_serialize(
            test_set_id=test_set_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TestSetsAPIListTestSetRecordsResponse",
            '401': "TestSetsAPIErrorResponse",
            '404': "TestSetsAPIErrorResponse",
            '500': "TestSetsAPIErrorResponse",
        }
    ...
    @validate_call
    def list_test_set_records_with_http_info(
        self,
        test_set_id: Annotated[StrictStr, Field(description="Test set id.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TestSetsAPIListTestSetRecordsResponse]:
        """List test set records
    ...
    @validate_call
    def list_test_set_records_without_preload_content(
        self,
        test_set_id: Annotated[StrictStr, Field(description="Test set id.")],
        _request_timeout: Union[
            None,
    ...
    def _list_test_set_records_serialize(
        self,
        test_set_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/test-sets/{test_set_id}/records',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
