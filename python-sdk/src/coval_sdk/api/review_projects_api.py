...
class ReviewProjectsApi:
    ...
    @validate_call
    def get_review_disagreement_state(
        self,
        coval_reviews_api_get_review_disagreement_state_request: CovalReviewsAPIGetReviewDisagreementStateRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param coval_reviews_api_get_review_disagreement_state_request: (required)
        :type coval_reviews_api_get_review_disagreement_state_request: CovalReviewsAPIGetReviewDisagreementStateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._get_review_disagreement_state_serialize(
            coval_reviews_api_get_review_disagreement_state_request=coval_reviews_api_get_review_disagreement_state_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CovalReviewsAPIReviewDisagreementStateResponse",
            '400': "CovalReviewsAPIErrorResponse",
            '401': "CovalReviewsAPIErrorResponse",
    ...
    @validate_call
    def get_review_disagreement_state_with_http_info(
        self,
        coval_reviews_api_get_review_disagreement_state_request: CovalReviewsAPIGetReviewDisagreementStateRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CovalReviewsAPIReviewDisagreementStateResponse]:
        """Get review disagreement state
    ...
    @validate_call
    def get_review_disagreement_state_without_preload_content(
        self,
        coval_reviews_api_get_review_disagreement_state_request: CovalReviewsAPIGetReviewDisagreementStateRequest,
        _request_timeout: Union[
            None,
    ...
    def _get_review_disagreement_state_serialize(
        self,
        coval_reviews_api_get_review_disagreement_state_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if coval_reviews_api_get_review_disagreement_state_request is not None:
            _body_params = coval_reviews_api_get_review_disagreement_state_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/review-projects/disagreement-state',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_review_project_progress(
        self,
        project_id: Annotated[StrictStr, Field(description="The project ID (ULID)")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_review_project_progress_serialize(
            project_id=project_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CovalReviewsAPIReviewProjectProgress",
            '400': "CovalReviewsAPIErrorResponse",
            '401': "CovalReviewsAPIErrorResponse",
            '403': "CovalReviewsAPIErrorResponse",
            '404': "CovalReviewsAPIErrorResponse",
    ...
    @validate_call
    def get_review_project_progress_with_http_info(
        self,
        project_id: Annotated[StrictStr, Field(description="The project ID (ULID)")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CovalReviewsAPIReviewProjectProgress]:
        """Get review project progress
    ...
    @validate_call
    def get_review_project_progress_without_preload_content(
        self,
        project_id: Annotated[StrictStr, Field(description="The project ID (ULID)")],
        _request_timeout: Union[
            None,
    ...
    def _get_review_project_progress_serialize(
        self,
        project_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/review-projects/{project_id}/progress',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
