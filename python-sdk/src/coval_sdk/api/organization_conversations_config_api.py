...
class OrganizationConversationsConfigApi:
    ...
    def get_conversation_metrics(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CovalOrganizationAPIConversationMetricsConfig",
    ...
    def _get_conversation_metrics_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/organization/conversation-metrics',
    ...
    def _update_conversation_metrics_serialize(
        ...
        if coval_organization_api_update_conversation_metrics_request is not None:
            _body_params = coval_organization_api_update_conversation_metrics_request
    ...
    def update_monitoring_metrics(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("PATCH /organization/monitoring-metrics is deprecated.", DeprecationWarning)
