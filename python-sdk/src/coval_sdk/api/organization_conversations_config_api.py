...
class OrganizationConversationsConfigApi:
    ...
    def get_monitoring_metrics(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CovalOrganizationAPIMonitoringMetricsConfig",
            '401': "CovalOrganizationAPIErrorResponse",
            '403': "CovalOrganizationAPIErrorResponse",
            '404': "CovalOrganizationAPIErrorResponse",
            '500': "CovalOrganizationAPIErrorResponse",
        }
    ...
    def _get_monitoring_metrics_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/organization/monitoring-metrics',
    ...
    def update_monitoring_metrics(
        self,
        coval_organization_api_update_monitoring_metrics_request: CovalOrganizationAPIUpdateMonitoringMetricsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._update_monitoring_metrics_serialize(
            coval_organization_api_update_monitoring_metrics_request=coval_organization_api_update_monitoring_metrics_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CovalOrganizationAPIMonitoringMetricsConfig",
            '400': "CovalOrganizationAPIErrorResponse",
            '401': "CovalOrganizationAPIErrorResponse",
            '403': "CovalOrganizationAPIErrorResponse",
            '404': "CovalOrganizationAPIErrorResponse",
            '500': "CovalOrganizationAPIErrorResponse",
    ...
    def _update_monitoring_metrics_serialize(
        self,
        coval_organization_api_update_monitoring_metrics_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if coval_organization_api_update_monitoring_metrics_request is not None:
            _body_params = coval_organization_api_update_monitoring_metrics_request
