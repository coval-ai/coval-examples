...
class RunsApi:
    ...
    def delete_run(
        self,
        run_id: Annotated[str, Field(min_length=22, strict=True, max_length=22, description="Unique identifier for the run")],
        ...
        :param run_id: Unique identifier for the run (required)
        :type run_id: str
    ...
    def launch_run(
        self,
        coval_runs_api_launch_run_request: CovalRunsAPILaunchRunRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param coval_runs_api_launch_run_request: (required)
        :type coval_runs_api_launch_run_request: CovalRunsAPILaunchRunRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._launch_run_serialize(
            coval_runs_api_launch_run_request=coval_runs_api_launch_run_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def launch_run_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CovalRunsAPILaunchRunResponse]:
        """Launch run
    ...
    @validate_call
    def launch_run_without_preload_content(
        self,
        coval_runs_api_launch_run_request: CovalRunsAPILaunchRunRequest,
        _request_timeout: Union[
            None,
    ...
    def _launch_run_serialize(
        self,
        coval_runs_api_launch_run_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if coval_runs_api_launch_run_request is not None:
            _body_params = coval_runs_api_launch_run_request
    ...
    def update_run(
        self,
        run_id: Annotated[str, Field(min_length=22, strict=True, max_length=22, description="Unique identifier for the run")],
        coval_runs_api_update_run_request: CovalRunsAPIUpdateRunRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param run_id: Unique identifier for the run (required)
        :type run_id: str
        :param coval_runs_api_update_run_request: (required)
        :type coval_runs_api_update_run_request: CovalRunsAPIUpdateRunRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_run_serialize(
            run_id=run_id,
            coval_runs_api_update_run_request=coval_runs_api_update_run_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_run_serialize(
        self,
        run_id,
        coval_runs_api_update_run_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if coval_runs_api_update_run_request is not None:
            _body_params = coval_runs_api_update_run_request
