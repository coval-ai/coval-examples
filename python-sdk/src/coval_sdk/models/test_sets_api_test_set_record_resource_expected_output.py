...
TESTSETSAPITESTSETRECORDRESOURCEEXPECTEDOUTPUT_ANY_OF_SCHEMAS = ["Dict[str, object]", "List[object]", "bool", "float", "str"]

class TestSetsAPITestSetRecordResourceExpectedOutput(BaseModel):
    """
    ...
    any_of_schemas: Set[str] = { "Dict[str, object]", "List[object]", "bool", "float", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = TestSetsAPITestSetRecordResourceExpectedOutput.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in TestSetsAPITestSetRecordResourceExpectedOutput with anyOf schemas: Dict[str, object], List[object], bool, float, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into TestSetsAPITestSetRecordResourceExpectedOutput with anyOf schemas: Dict[str, object], List[object], bool, float, str. Details: " + ", ".join(error_messages))
        else:
            return instance
