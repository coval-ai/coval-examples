...
class CovalMonitorsAPITestEvaluateResponse(BaseModel):
    """
    CovalMonitorsAPITestEvaluateResponse
    """ # noqa: E501
    monitor_id: StrictStr = Field(description="Monitor ULID")
    run_id: StrictStr = Field(description="Run that was evaluated")
    triggered: StrictBool = Field(description="Whether the monitor would have triggered")
    ...
    __properties: ClassVar[List[str]] = ["monitor_id", "run_id", "triggered", "suppressed", "condition_results", "dispatch_results", "message"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalMonitorsAPITestEvaluateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalMonitorsAPITestEvaluateResponse from a dict"""
        if obj is None:
            return None
