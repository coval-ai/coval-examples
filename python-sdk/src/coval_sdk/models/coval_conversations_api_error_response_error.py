...
class CovalConversationsAPIErrorResponseError(BaseModel):
    """
    ...
    details: Optional[List[CovalConversationsAPIErrorDetail]] = Field(default=None, description="Additional error details")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalConversationsAPIErrorResponseError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalConversationsAPIErrorResponseError from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "details": [CovalConversationsAPIErrorDetail.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
