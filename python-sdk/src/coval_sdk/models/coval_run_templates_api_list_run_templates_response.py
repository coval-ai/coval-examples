...
class CovalRunTemplatesAPIListRunTemplatesResponse(BaseModel):
    """
    CovalRunTemplatesAPIListRunTemplatesResponse
    """ # noqa: E501
    run_templates: List[CovalRunTemplatesAPIRunTemplateResource]
    next_page_token: Optional[StrictStr] = Field(default=None, description="Token for fetching next page (null if no more results)")
    total_count: Optional[StrictInt] = Field(default=None, description="Total count of templates matching filter")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["run_templates", "next_page_token", "total_count"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalRunTemplatesAPIListRunTemplatesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalRunTemplatesAPIListRunTemplatesResponse from a dict"""
        if obj is None:
            return None
