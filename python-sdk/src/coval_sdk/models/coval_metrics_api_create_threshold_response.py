...
class CovalMetricsAPICreateThresholdResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalMetricsAPICreateThresholdResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalMetricsAPICreateThresholdResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "threshold": CovalMetricsAPIMetricThresholdResource.from_dict(obj["threshold"]) if obj.get("threshold") is not None else None
        })
