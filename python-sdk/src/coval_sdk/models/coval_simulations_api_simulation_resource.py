...
class CovalSimulationsAPISimulationResource(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "simulation_id", "run_id", "status", "create_time", "agent_id", "persona_id", "test_set_id", "test_case_id", "has_audio", "error_message", "mutation_id", "mutation_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalSimulationsAPISimulationResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalSimulationsAPISimulationResource from a dict"""
        if obj is None:
            return None
