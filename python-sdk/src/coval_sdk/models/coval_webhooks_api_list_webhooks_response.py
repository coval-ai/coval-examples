...
class CovalWebhooksAPIListWebhooksResponse(BaseModel):
    """
    CovalWebhooksAPIListWebhooksResponse
    """ # noqa: E501
    webhooks: List[CovalWebhooksAPIWebhookResource] = Field(description="List of webhook resources")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalWebhooksAPIListWebhooksResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalWebhooksAPIListWebhooksResponse from a dict"""
        if obj is None:
            return None
