...
class CovalTagsAPIListTagsResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalTagsAPIListTagsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalTagsAPIListTagsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "tags": deserialize_model_list(obj["tags"], CovalTagsAPITagResource, response_model="CovalTagsAPIListTagsResponse", field="tags") if obj.get("tags") is not None else None,
