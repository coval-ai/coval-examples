...
class CovalConversationsAPIMetricOutputResource(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["metric_output_id", "metric_id", "metric_version_ulid", "value", "status", "status_reason", "explanation", "result"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalConversationsAPIMetricOutputResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalConversationsAPIMetricOutputResource from a dict"""
        if obj is None:
            return None
