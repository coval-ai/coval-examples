...
class CovalMetricsAPISchemaColumnResource(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalMetricsAPISchemaColumnResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalMetricsAPISchemaColumnResource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "enum": CovalMetricsAPIColumnEnumResource.from_dict(obj["enum"]) if obj.get("enum") is not None else None
        })
