...
class CovalAPIKeysAPIApiKeyResource(BaseModel):
    """
    ...
    api_key: Optional[StrictStr] = Field(default=None, description="The API key value (masked except during creation).")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalAPIKeysAPIApiKeyResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalAPIKeysAPIApiKeyResource from a dict"""
        if obj is None:
            return None
