...
class CovalMetricsAPIErrorResponseError(BaseModel):
    """
    CovalMetricsAPIErrorResponseError
    """ # noqa: E501
    code: StrictStr
    message: StrictStr
    details: Optional[List[CovalMetricsAPIErrorResponseErrorDetailsInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalMetricsAPIErrorResponseError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalMetricsAPIErrorResponseError from a dict"""
        if obj is None:
            return None
