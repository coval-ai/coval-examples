...
class CovalSimulationsAPISimpleMetricOutput(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["metric_output_id", "metric_id", "value", "status", "subvalues_by_timestamp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalSimulationsAPISimpleMetricOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalSimulationsAPISimpleMetricOutput from a dict"""
        if obj is None:
            return None
