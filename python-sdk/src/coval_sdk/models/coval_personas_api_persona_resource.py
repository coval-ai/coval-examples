...
class CovalPersonasAPIPersonaResource(BaseModel):
    ...
    background_sound: Optional[StrictStr] = Field(default=None, description="Background noise type. Use `backchanneling` to add short listener cues like \"mm-hmm\" and \"yeah\" that simulate an engaged caller. Use `off` to disable background sound. All remaining values add ambient environmental noise. ")
