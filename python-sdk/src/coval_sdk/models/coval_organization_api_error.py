...
class CovalOrganizationAPIError(BaseModel):
    """
    ...
    details: Optional[Annotated[List[CovalOrganizationAPIErrorDetail], Field(max_length=100)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalOrganizationAPIError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalOrganizationAPIError from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "details": [CovalOrganizationAPIErrorDetail.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
