...
class TestCasesAPIUpdateTestCaseRequest(BaseModel):
    """
    Update request. Only provided fields will be updated.
    """ # noqa: E501
    input_str: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Input for the test case")
    test_set_id: Optional[Annotated[str, Field(min_length=8, strict=True, max_length=8)]] = Field(default=None, description="Test set ID (can move to different test set)")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TestCasesAPIUpdateTestCaseRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TestCasesAPIUpdateTestCaseRequest from a dict"""
        if obj is None:
            return None
