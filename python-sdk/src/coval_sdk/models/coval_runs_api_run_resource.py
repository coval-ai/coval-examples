...
class CovalRunsAPIRunResource(BaseModel):
    ...
    is_public: Optional[StrictBool] = Field(default=False, description="Whether the run is shared via a public link.")
    status: CovalRunsAPISimulationStatus = Field(description="Current status of the simulation run")
    ...
    progress: Optional[CovalRunsAPIRunProgress] = None
    results: Optional[CovalRunsAPIRunResults] = None
    ...
    error_status: Optional[StrictStr] = Field(default=None, description="Structured run outcome or error status code.")
    metric_averages: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(default=None, description="Average value per metric across the run's simulations, keyed by metric id. Present when the list request sets include=metric_averages or filters by metric value (filter=metric.<id> ...); omitted from the default summary view. ")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalRunsAPIRunResource from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # set to None if metric_averages (nullable) is None
        # and model_fields_set contains the field
        if self.metric_averages is None and "metric_averages" in self.model_fields_set:
            _dict['metric_averages'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalRunsAPIRunResource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "progress": CovalRunsAPIRunProgress.from_dict(obj["progress"]) if obj.get("progress") is not None else None,
            "results": CovalRunsAPIRunResults.from_dict(obj["results"]) if obj.get("results") is not None else None,
            "metadata": obj.get("metadata"),
            "error": obj.get("error"),
            "error_status": obj.get("error_status"),
            "metric_averages": obj.get("metric_averages")
        })
