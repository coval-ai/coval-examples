...
class CovalMetricsAPICreateMetricRequest(BaseModel):
    """
    ...
    metadata_field_type: Optional[CovalMetricsAPIMetadataFieldType] = Field(default=None, description="Field type. Required for METRIC_METADATA_FIELD.")
    metadata_field_key: Optional[StrictStr] = Field(default=None, description="Metadata key. Required for METRIC_METADATA_FIELD.")
    regex_pattern: Optional[StrictStr] = Field(default=None, description="Regex pattern. Required for METRIC_TRANSCRIPT_REGEX.")
    role: Optional[StrictStr] = Field(default=None, description="Speaker role filter. Aliases user and assistant are normalized on write.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalMetricsAPICreateMetricRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalMetricsAPICreateMetricRequest from a dict"""
        if obj is None:
            return None
