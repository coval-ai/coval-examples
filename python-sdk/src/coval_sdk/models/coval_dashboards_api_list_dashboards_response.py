...
class CovalDashboardsAPIListDashboardsResponse(BaseModel):
    """
    CovalDashboardsAPIListDashboardsResponse
    """ # noqa: E501
    dashboards: List[CovalDashboardsAPIDashboardResource]
    ...
    __properties: ClassVar[List[str]] = ["dashboards", "next_page_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalDashboardsAPIListDashboardsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalDashboardsAPIListDashboardsResponse from a dict"""
        if obj is None:
            return None
