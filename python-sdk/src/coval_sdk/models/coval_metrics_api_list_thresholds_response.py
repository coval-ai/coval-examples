...
class CovalMetricsAPIListThresholdsResponse(BaseModel):
    """
    CovalMetricsAPIListThresholdsResponse
    """ # noqa: E501
    thresholds: List[CovalMetricsAPIMetricThresholdResource]
    next_page_token: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["thresholds", "next_page_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalMetricsAPIListThresholdsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalMetricsAPIListThresholdsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "thresholds": deserialize_model_list(obj["thresholds"], CovalMetricsAPIMetricThresholdResource, response_model="CovalMetricsAPIListThresholdsResponse", field="thresholds") if obj.get("thresholds") is not None else None,
