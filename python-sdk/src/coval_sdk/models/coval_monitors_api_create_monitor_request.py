...
class CovalMonitorsAPICreateMonitorRequest(BaseModel):
    """
    ...
    scope: Optional[CovalMonitorsAPIMonitorScope] = None
    match_mode: Optional[CovalMonitorsAPIMonitorMatchMode] = None
    ...
    conditions: Annotated[List[CovalMonitorsAPIConditionInput], Field(min_length=1)]
    channels: Optional[List[CovalMonitorsAPIChannelInput]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalMonitorsAPICreateMonitorRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalMonitorsAPICreateMonitorRequest from a dict"""
        if obj is None:
            return None
