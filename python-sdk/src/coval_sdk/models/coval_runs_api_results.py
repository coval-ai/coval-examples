...
class CovalRunsAPIResults(BaseModel):
    """
    Results summary (only for COMPLETED runs)
    """ # noqa: E501
    output_ids: List[StrictStr] = Field(description="IDs of simulation outputs (test case results)")
    metrics: Dict[str, CovalRunsAPIMetricSummary] = Field(description="Aggregated metric results")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalRunsAPIResults from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalRunsAPIResults from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "metrics": dict(
                (_k, CovalRunsAPIMetricSummary.from_dict(_v))
