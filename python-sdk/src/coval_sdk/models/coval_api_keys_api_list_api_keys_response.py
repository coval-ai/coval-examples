...
class CovalAPIKeysAPIListApiKeysResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalAPIKeysAPIListApiKeysResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalAPIKeysAPIListApiKeysResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "api_keys": deserialize_model_list(obj["api_keys"], CovalAPIKeysAPIApiKeyResource, response_model="CovalAPIKeysAPIListApiKeysResponse", field="api_keys") if obj.get("api_keys") is not None else None,
