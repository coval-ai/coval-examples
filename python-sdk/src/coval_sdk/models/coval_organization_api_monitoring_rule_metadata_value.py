...
COVALORGANIZATIONAPIMONITORINGRULEMETADATAVALUE_ANY_OF_SCHEMAS = ["List[str]", "bool", "str"]

class CovalOrganizationAPIMonitoringRuleMetadataValue(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = CovalOrganizationAPIMonitoringRuleMetadataValue.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in CovalOrganizationAPIMonitoringRuleMetadataValue with anyOf schemas: List[str], bool, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into CovalOrganizationAPIMonitoringRuleMetadataValue with anyOf schemas: List[str], bool, str. Details: " + ", ".join(error_messages))
        else:
            return instance
