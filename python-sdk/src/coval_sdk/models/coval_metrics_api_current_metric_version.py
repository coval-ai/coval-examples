...
class CovalMetricsAPICurrentMetricVersion(BaseModel):
    """
    The metric's live version, embedded on MetricResource.
    """ # noqa: E501
    ulid: StrictStr = Field(description="Identifier of the current version row (26-char ULID)")
    ...
    __properties: ClassVar[List[str]] = ["ulid", "version_number", "change_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalMetricsAPICurrentMetricVersion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalMetricsAPICurrentMetricVersion from a dict"""
        if obj is None:
            return None
