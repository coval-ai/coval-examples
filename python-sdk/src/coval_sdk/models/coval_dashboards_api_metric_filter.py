...
class CovalDashboardsAPIMetricFilter(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalDashboardsAPIMetricFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalDashboardsAPIMetricFilter from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "value": CovalDashboardsAPIMetricFilterValue.from_dict(obj["value"]) if obj.get("value") is not None else None,
