...
class CovalWorkspacesAPIWorkspaceResource(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "slug", "display_name", "status", "workspace_type", "created_at", "last_updated_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalWorkspacesAPIWorkspaceResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalWorkspacesAPIWorkspaceResource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "workspace_type": obj.get("workspace_type"),
