...
class CovalTemplatesAPIListTemplatesResponse(BaseModel):
    """
    CovalTemplatesAPIListTemplatesResponse
    """ # noqa: E501
    templates: List[CovalTemplatesAPITemplateResource] = Field(description="List of template resources")
    ...
    __properties: ClassVar[List[str]] = ["templates", "next_page_token"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalTemplatesAPIListTemplatesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalTemplatesAPIListTemplatesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "templates": [CovalTemplatesAPITemplateResource.from_dict(_item) for _item in obj["templates"]] if obj.get("templates") is not None else None,
