...
class CovalConversationsAPIConversationProgress(BaseModel):
    """
    CovalConversationsAPIConversationProgress
    """ # noqa: E501
    total_metrics: Optional[StrictInt] = Field(default=None, description="Total number of metrics being evaluated")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalConversationsAPIConversationProgress from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalConversationsAPIConversationProgress from a dict"""
        if obj is None:
            return None
