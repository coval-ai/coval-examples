...
class CovalRunsAPIError(BaseModel):
    """
    CovalRunsAPIError
    """ # noqa: E501
    ...
    details: Optional[List[CovalRunsAPIErrorDetail]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalRunsAPIError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalRunsAPIError from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "details": [CovalRunsAPIErrorDetail.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
