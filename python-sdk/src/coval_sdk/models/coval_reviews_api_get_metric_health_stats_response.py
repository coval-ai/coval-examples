...
class CovalReviewsAPIGetMetricHealthStatsResponse(BaseModel):
    """
    CovalReviewsAPIGetMetricHealthStatsResponse
    """ # noqa: E501
    conversations: StrictInt
    annotations: StrictInt
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CovalReviewsAPIGetMetricHealthStatsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CovalReviewsAPIGetMetricHealthStatsResponse from a dict"""
        if obj is None:
            return None
